...
void Initialize()
{
	...
	SceneManager::Instance()->EnqueueScene(new Soft_body("Soft body with spring constraint"));
	SceneManager::Instance()->EnqueueScene(new Score("Score"));
	SceneManager::Instance()->EnqueueScene(new Scene_CollisionHandling("Cuda Collision"));
}
