...
class Maze_Renderer : public GameObject
{
public:
	Maze_Renderer(Maze_Generator1* gen, Mesh* wallmesh = CommonMeshes::Cube());
	virtual ~Maze_Renderer();
	...
	uint Generate_FlatMaze(int walls[], int numwalls);
