...
public:
	...
	void IncreaseScore() { score = score + 100; };
	void DecreaseScore() { score = score - 50; };
...
//Added in Tutorial 2
	...
	Vector3		position;
	Vector3		linVelocity;
	Vector3		linvelocityprev;
	Vector3		linvelocitytemp1;
	Vector3		linvelocitytemp2;
	Vector3		linvelocitytemp3;
	Vector3		linvelocitytemp4;
	Vector3		force;
	float		invMass;
	...
	Quaternion  orientation;
	Vector3		angVelocity;
	Vector3		angvelocityprev;
	Vector3		angvelocitytemp1;
	Vector3		angvelocitytemp2;
	Vector3		angvelocitytemp3;
	Vector3		angvelocitytemp4;
	Vector3		torque;
	Matrix3     invInertia;
