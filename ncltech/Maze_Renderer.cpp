...
Maze_Renderer::Maze_Renderer(Maze_Generator1* gen, Mesh* wallmesh)
	: GameObject("")
	, mesh(wallmesh)
	, maze(gen)
	, flat_maze(NULL)
...
void Maze_Renderer::DrawSearchHistory(const SearchHistory& history, float line_width)
{
...
uint Maze_Renderer::Generate_FlatMaze()
{
...
uint Maze_Renderer::Generate_FlatMaze(int walls[], int numwalls)
{
	//Generates a 3xsize by 3xsize array of booleans, where 
	// a true value corresponds to a solid wall and false to open space.
	// - Each GraphNode is a 2x2 open space with a 1 pixel wall around it.
...
void Maze_Renderer::Generate_ConstructWalls()
{
...
void Maze_Renderer::Generate_BuildRenderNodes()
{
